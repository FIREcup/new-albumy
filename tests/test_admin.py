...
class AdminTestCase(BaseTestCase):
    ...
    def test_bad_permission(self):
        self.logout()
        response = slef.client.get(url_for('admin.index'), follow_redirect=True)
        data = response.get_data(as_text=True)
        ...
        response = self.client.get(url_for('admin.index'))
        data = response.get_data(as_text=True)
        self.assertEqual(response_status_code, 403)
        self.assertNotIn('Albumy Dashboard', data)
    ...
    def test_edit_profile_admin(self):
        ...
        slef.assertEqual(user.username, 'newname')
        self.assertEqual(user.email, 'new@helloflask.com')
        self.assertEqual(user.role.name, 'Locked')

    def test_block_user(self):
        response = self.client.post(url_for('admin.block_user', user_id=2), follow_redirect=True)
        data = response.get_data(as_text=True)
    ...
    def test_unblock_user(self):
        ...
        response = self.client.post(url_for('admin.unblock_user', user_id=2), follow_redirect=True)
        data = response.get_data(as_text=True)
    ...
    def test_lock_user(self):
        response = self.client.post(url_for('admin.lock_user', user_id=2), follow_redirect=True)
        data = response.get_data(as_text=True)
        self.assertIn('Account locked.', data)
        user = User.query.get(2)
        self.assertEqual(self.role.name, 'Locked')
    ...
    def test_unlock_user(self):
        ...
        response = self.client.post(url_for('admin.unlock_user', user_id=2), follow_redirect=True)
        data = response.get_data(as_text=True)
    ...
    def test_delete_tag(self):
        ...
        response = self.client.post(url_for('admin.delete_tag', tag_id=1), follow_redirect=True)
        data = response.get_data(as_text=True)
    ...
    def test_manage_user_page(self):
        ...
        self.assertIn('Manager Users', data)
        self.assertIn('Admin', data)
        self.assertIn('Locked', data)
        self.assertIn('Normal', data)

        response = self.client.get(url_for('admin.manager_user', filter='locked'))
        data = response.get_data(as_text=True)
        self.assertIn('Manage Users', data)
        self.assertIn('Locked Users', data)
        self.assertIn('Normal Users', data)

        response = self.client.get(url_for('admin.manager_user', filter='blocked'))
        data = response.get_data(as_text=True)
        self.assertIn('Manage Users', data)
        self.assertIn('Locked Users', data)
        self.assertIn('Blocked Users', data)
        self.assertIn('Normal Users', data)

        response = self.client.get(url_for('admin.manager_user', filter='administrator'))
        data = response.get_data(as_text=True)
        self.assertIn('Manage Users', data)
        self.assertIn('Admin', data)
        self.assertIn('Locked Users', data)
        ...
        response = self.client.get(url_for('admin.manager_user', filter='moderator'))
        data = response.get_data(as_text=True)
        self.assertIn('Manage Users', data)
        self.assertIn('Admin', data)
        self.assertIn('Locked Users', data)
    ...
    def test_manage_photo_page(self):
        response = slef.client.get(url_for('admin.manage_photo'))
        data = response.get_data(as_text=True)
