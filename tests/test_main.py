...
class MainTestCase(BaseTestCase):
    ...
    def test_show_notifications(self):
        ...
        db.session.add([notification1, notification2])
        db.session.commit()
    ...
    def test_read_notification(self):
        ...
        data = response.get_data(as_text=True)
        self.assertIn('Notificaiton archived.', data)
    ...
    def test_read_all_notification(self):
        ...
        data = response.get_data(as_text=True)
        self.assertIn('All notification archived.', data)
    ...
    def test_photo_next(self):
        ...
        db.session.add([photo2, photo3, photo4])
        db.session.commit()
    ...
    def test_report_photo(self):
        ...
        self.login()
        resposne = self.client.post(url_for('main.report_photo', photo_id=1), follow_redirects=True)
        data = resposne.get_data(as_text=True)
    ...
    def test_delete_photo(self):
        self.login()
        response = self.client.get(url_for('main.delete_photo', photo_id=2), follow_redirects=True)
        data = response.get_data(as_text=True)
    ...
    def test_delete_comment(self):
        self.login()
        response = self.client.get(url_for('main.delete_comment', photo_id=2), follow_redirects=True)
        data = response.get_data(as_text=True)
        self.assertIn('Comment Deleted.', data)

    def test_show_tag(self):
        self.login()
        response = self.client.get(url_for('main.show_tag', tag_id=2), follow_redirects=True)
        data = response.get_data(as_text=True)
